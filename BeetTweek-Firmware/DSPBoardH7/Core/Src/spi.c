...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI5_MspDeInit 0 */
    ...
    PF9     ------> SPI5_MOSI
    */
    HAL_GPIO_DeInit(GPIOF, AS5048_SCK_Pin|AS5048_MISO_Pin|AS5048_MOSI_Pin);
  ...
  /* USER CODE END SPI6_MspDeInit 0 */
    ...
    PG14     ------> SPI6_MOSI
    */
    HAL_GPIO_DeInit(GPIOG, MOTOR_BOARD_NSS_Pin|MOTOR_BOARD_SPI_MISO_Pin|MOTOR_BOARD_SPI_CLK_Pin|MOTOR_BOARD_SPI_MOSI_Pin);
