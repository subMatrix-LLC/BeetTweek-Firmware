...
float TIM3_RESET_TIME = 0;
float TIM4_RESET_TIME = 0;
float TIM5_RESET_TIME = 0;
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE BEGIN TIM2_MspInit 0 */
	  ...
	  TIM2_RESET_TIME = HAL_CalculateTimerResetTime(tim_baseHandle);
  ...
  /* USER CODE BEGIN TIM4_MspInit 0 */
	  //calculate some sampling times
	  TIM4_RESET_TIME = HAL_CalculateTimerResetTime(tim_baseHandle);
  ...
  /* USER CODE BEGIN TIM5_MspInit 0 */
	 TIM5_RESET_TIME = HAL_CalculateTimerResetTime(tim_baseHandle);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PB1     ------> TIM3_CH4
    */
    GPIO_InitStruct.Pin = DRV8313_IN1_Pin|DRV8313_IN2_Pin;
    ...
    GPIO_InitStruct.Pin = DRV8313_IN3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
