...
enum EEPROMAddresses {
	...
	EE_GESTURE_STATESAVED_BOOL_8bits = EE_MODE_MEMORY_16 + EE_BYTES_PER_MODE,
	EE_GESTURE_STATE_32bits     = EE_GESTURE_STATESAVED_BOOL_8bits + 1,
	EE_GESTURE_ENDIDX_32bits    = EE_GESTURE_STATE_32bits + 4,
	EE_GESTURE_TEMPO_FLOAT_32bits     = EE_GESTURE_ENDIDX_32bits + 4,
	EE_GESTURE_MOTORSTATE_nbits       = EE_GESTURE_TEMPO_FLOAT_32bits + 4,


	EE_FAKE_PLUG_STATES_4_8bits = EE_GESTURE_MOTORSTATE_nbits + sizeof(MotorAngleState)+21,

	EE_TAP_TEMPO_TNEXT_32bits = EE_FAKE_PLUG_STATES_4_8bits + 4,
	EE_TAP_TEMPO_BPS_32bits = EE_TAP_TEMPO_TNEXT_32bits + 4,
	EE_TAP_TEMPO_BPSFLT_32bits = EE_TAP_TEMPO_BPS_32bits + 4,

	EE_FLIPPED_FRONT_PLATE_32bits = EE_TAP_TEMPO_BPSFLT_32bits + 4,

	EE_FIRMWARE_VERSION_32bits = EE_FLIPPED_FRONT_PLATE_32bits + 4,
